...
//the Create function: In this function we are creating our assets by calling the sprites from the preload function
    create : function () {
        ...
        speedText = game.add.text(10, 440, 'Player-Speed: ' + speed + '/200', {font: '25px Agency FB', fill: '#3BE2F8'});
        
        bulletSpeedText = game.add.text(10, 480, 'Bullet-Speed: ' + bulletSpeed + '/200', {font: '25px Agency FB', fill: '#3BE2F8'});
    ...
    function unpause(event){
        ...
        if(game.paused){
            ...
            if(event.x > x1 && event.x < x2 && event.y > y1 && event.y < y2 ){
                ...
                if(money >= 10 && bulletSpeed < 200){
                bulletSpeed = bulletSpeed + 50;
                money = money - 10;
                moneyText.text = 'Scraps: ' + money;
                bulletSpeedText.text = 'Bullet-Speed: ' + bulletSpeed + '/200';
                ...
                if(money >= 100 && speed < 200){
                speed = speed + 50;
                money = money - 100;
                speedText.text = 'Player-Speed: ' + speed + '/200';
                moneyText.text = 'Scraps: ' + money;
                ...
                choiseLabel.text = 'Purchased Money Muliplier';
                     xValue = xValue + 2;
                  multiplierMoneyText.text = 'Money-Multiplier: ' + xValue + '/8';
                }
